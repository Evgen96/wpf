...
z-index: 0;}
    ...
    <?php if(rehub_option('rehub_custom_color_nav') !='' && rehub_option('rehub_headercolor_style') =='2') : ?>
		header .main-nav, header.dark_header .main-nav{
    ...
    <?php if(rehub_option('rehub_custom_color_nav_font') !='' && rehub_option('rehub_headercolor_style') =='2') : ?>
		nav.top_menu ul li a, header.dark_header nav.top_menu ul li a{
	...
	<?php endif; ?>							
<?php if(rehub_option('rehub_custom_color') || rehub_option('rehub_color_schema') !='default') : ?>
	<?php 
...
nav.top_menu > ul > li > a:hover{border-top-color: <?php echo $colorschema; ?>; }
