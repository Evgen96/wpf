	...
	'template'    => array(
		...
		array(
			...
			'fields'    => array(
				...
				array(
					'type' => 'toggle',
					'name' => 'review_post_product_countdown',
					'label' => __('Enable countdown for offer?', 'rehub_framework'),
					'description' => __('Please, use only on product reviews', 'rehub_framework'),					
				),	

				array(
					'type'      => 'textbox',
					'name'      => 'review_post_product_timer_year',
					'label'     => __('Countdown year (example:2014)', 'rehub_framework'),
					'validation' => 'numeric',
					'dependency' => array(
						'field' => 'review_post_product_countdown',
						'function' => 'vp_dep_boolean',
					),
				...
				array(
					'type'      => 'textbox',
					'name'      => 'review_post_product_timer_month',
					'label'     => __('Countdown month (example:1)', 'rehub_framework'),
					'validation' => 'numeric',
					'dependency' => array(
						'field' => 'review_post_product_countdown',
						'function' => 'vp_dep_boolean',
				...
				array(
					'type'      => 'textbox',
					'name'      => 'review_post_product_timer_day',
					'label'     => __('Countdown day (example:30)', 'rehub_framework'),
					'validation' => 'numeric',
					'dependency' => array(
						'field' => 'review_post_product_countdown',
						'function' => 'vp_dep_boolean',
				...
				array(
					'type'      => 'textbox',
					'name'      => 'review_post_product_timer_hour',
					'label'     => __('Countdown hour (example:12)', 'rehub_framework'),
					'validation' => 'numeric',
					'dependency' => array(
						'field' => 'review_post_product_countdown',
						'function' => 'vp_dep_boolean',
				...
				array(
					...
					'title'     => __('Product review with affiliate links list', 'rehub_framework'),
					'dependency' => array(
						'field'    => 'review_post_schema_type',
