		...
		<main id="main" class="site-main" role="main">
			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					<?php if ( slug_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
					...
					<?php
						...
						$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'slug' ), convert_smilies( ':)' ) ) . '</p>';
